...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 30 22:38:16 2017
...
fp = pipeline.Pipeline([
    ('union', pipeline.FeatureUnion(
        ...
        transformer_list = [
            ...
            #commented for Kaggle Limits
            ('pi3', pipeline.Pipeline([('Text', cust_txt_col('Text')), ('tfidf_Text', feature_extraction.text.TfidfVectorizer(ngram_range=(1, 2))), ('tsvd3', decomposition.TruncatedSVD(n_components=5000, n_iter=25, random_state=12))]))
        ])
    )])
